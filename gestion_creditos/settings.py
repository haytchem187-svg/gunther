...
# Si SECRET_KEY no está en las variables de entorno, usa una clave de desarrollo NO SEGURA.
# Esto EVITA que la aplicación se bloquee, pero te avisará si falta la clave.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'creditos.context_processors.empresa_actual',
            ],
        },
    },
]
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'creditos:dashboard'
